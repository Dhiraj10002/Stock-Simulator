...
import { PieChart, SlidersHorizontal, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Real-time mark-to-market valuations and holdings across CNC, MIS, and F&O.
            </p>
          </div>
        ...
        <div className="p-6 rounded-xl bg-slate-900/60 border border-slate-800 text-center py-16 space-y-3">
          ...
          <h2 className="text-lg font-bold text-slate-200">Live Portfolio Desk</h2>
          <p className="text-sm text-slate-400 max-w-md mx-auto">
            Full-width standalone portfolio view is being configured for Phase F3. You can manage and square off all your live positions right now inside the Pro Terminal.
          </p>
          <div className="pt-2">
            <Link
              href="/trade"
            ...
            >
              <span>Manage Positions in Terminal</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
        </div>
